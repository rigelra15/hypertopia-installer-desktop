...
const iconCollections = [
  ...
  },
  {
    ...
    icons: {
      'alert-twotone': {
        body: '<g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 3l9 17H3Z" fill="currentColor" fill-opacity="0.3"/><path d="M12 10v4M12 17v0.01" fill="none"/></g>'
      },
      'arrow-up-circle': {
        body: '<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M21 12c0 4.97-4.03 9-9 9c-4.97 0-9-4.03-9-9c0-4.97 4.03-9 9-9c4.97 0 9 4.03 9 9ZM12 17V7.5"/><path d="M12 7l4 4M12 7l-4 4" stroke-dasharray="8"/></g>'
      },
      'chevron-down': {
        body: '<path d="M12 16L5 9M12 16l7-7" stroke="currentColor" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
      },
      'chevron-right': {
        body: '<path d="M16 12L9 5M16 12l-7 7" stroke="currentColor" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
      },
      'clipboard-list': {
        body: '<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3h7v18H5V3Z" stroke-width="2"/><path d="M14.5 3.5v3h-5v-3"/><path d="M9 10h3M9 13h5M9 16h6" stroke-width="2"/></g>'
      },
      'cog-filled': {
        body: '<path d="M11 13l4.74-7.5c0.29 0.17 0.57 0.35 0.83 0.55l2.52-1.01c0.16-0.06 0.43-0.03 0.51 0.13l2.07 3.58c0.1 0.17 0.06 0.45-0.07 0.57L19.43 11c0.05 0.33 0.07 0.66 0.07 1ZM10.63 11.63l8.87 0.35c0 0.34-0.02 0.67-0.06 0.99l2.13 1.68c0.13 0.11 0.24 0.36 0.14 0.51l-2.07 3.58c-0.1 0.17-0.36 0.28-0.53 0.22l-2.54-1.04c-0.26 0.21-0.54 0.39-0.83 0.56ZM11.63 10.63l4.13 7.85c-0.29 0.17-0.59 0.32-0.89 0.44l-0.39 2.69c-0.03 0.17-0.19 0.39-0.37 0.38H9.97c-0.2 0-0.42-0.17-0.46-0.35l-0.37-2.72c-0.31-0.12-0.61-0.27-0.9-0.44ZM13 11l-4.74 7.5c-0.29-0.17-0.57-0.35-0.83-0.55l-2.52 1.01c-0.16 0.06-0.43 0.03-0.51-0.13l-2.07-3.58c-0.1-0.17-0.06-0.45 0.07-0.57L4.57 13c-0.05-0.33-0.07-0.66-0.07-1ZM13.37 12.37L4.5 12.02c0-0.34 0.02-0.67 0.06-0.99L2.43 9.35C2.3 9.24 2.19 8.99 2.29 8.84l2.07-3.58c0.1-0.17 0.36-0.28 0.53-0.22l2.54 1.04c0.26-0.21 0.54-0.39 0.83-0.56ZM12.37 13.37L8.24 5.52C8.53 5.35 8.83 5.2 9.13 5.08l0.39-2.69C9.55 2.22 9.71 2 9.89 2.01h4.14c0.2 0 0.42 0.17 0.46 0.35l0.37 2.72c0.31 0.12 0.61 0.27 0.9 0.44Z" fill="currentColor"/>'
      },
      'confirm-circle': {
        body: '<path d="M3 12c0-4.97 4.03-9 9-9c4.97 0 9 4.03 9 9c0 4.97-4.03 9-9 9c-4.97 0-9-4.03-9-9ZM8 12l3 3l5-5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>'
      },
      'download-loop': {
        body: '<g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 4h2v4.4h2.5L12 12.9M12 4h-2v4.4H7.5l4.5 4.5" fill="currentColor"/><path d="M6 19h12" fill="none"/></g>'
      },
      'downloading-loop': {
        body: '<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 21c-4.97 0-9-4.03-9-9c0-4.97 4.03-9 9-9"/><path d="M12 3c4.97 0 9 4.03 9 9c0 4.97-4.03 9-9 9" stroke-dasharray="2 4" stroke-dashoffset="2"/><path d="M12 8v7.5"/><path d="M12 15.5l3.5-3.5M12 15.5L8.5 12"/></g>'
      },
      'folder-filled': {
        body: '<g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 7h8c0.55 0 1 0.45 1 1v10c0 0.55-0.45 1-1 1H4c-0.55 0-1-0.45-1-1V7Z" fill="currentColor"/><path d="M12 7H3V6c0-0.55 0.45-1 1-1h6Z" fill="none"/></g>'
      },
      'loading-loop': {
        body: '<path d="M12 3c4.97 0 9 4.03 9 9" stroke="currentColor" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
      },
      'rotate-270': {
        body: '<path d="M12 6c3.31 0 6 2.69 6 6c0 3.31-2.69 6-6 6c-3.31 0-6-2.69-6-6V9.5M6 9l-3 3M6 9l3 3" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>'
      }
    }
  },
  {
...
export const offlineIconCount = 169
