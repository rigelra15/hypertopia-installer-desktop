    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          />
          <div className="fixed inset-0 z-50 flex items-start justify-center pt-16 p-4 pointer-events-none">
            <motion.div
              className={`w-full ${sizeMap[size]} max-h-[80vh] bg-white dark:bg-[#111] rounded-2xl shadow-2xl flex flex-col overflow-hidden pointer-events-auto`}
