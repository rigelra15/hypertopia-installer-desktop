      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-2xl max-h-[90vh] flex flex-col transform rounded-2xl bg-white dark:bg-[#111] p-6 shadow-2xl"
          >
            {/* Header */}
            <div className="mb-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-white/60">{t('changelog_desc')}</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            {/* Divider */}
            <div className="mb-4 h-px bg-gray-200 dark:bg-white/10"></div>
