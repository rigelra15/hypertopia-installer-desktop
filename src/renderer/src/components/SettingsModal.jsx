...
export function SettingsModal({
  ...
  const getStorageGradient = (percent) => {
    if (percent >= 90) return 'linear-gradient(90deg, #f87171 0%, #dc2626 100%)'
    if (percent >= 75) return 'linear-gradient(90deg, #fb923c 0%, #ea580c 100%)'
    if (percent >= 50) return 'linear-gradient(90deg, #facc15 0%, #ca8a04 100%)'
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="border-t border-gray-200 dark:border-white/10 pt-4">
            ...
            <div className="space-y-2 text-left">
              ...
              >
                <div className="flex min-w-0 items-center gap-3">
                  <Icon icon="line-md:clipboard-list" className="h-5 w-5 shrink-0 text-[#0081FB]" />
                  <div className="min-w-0 text-left">
                    <p className="text-sm font-medium text-gray-900 dark:text-white">
