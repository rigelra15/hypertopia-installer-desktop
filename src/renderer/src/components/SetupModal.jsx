      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-md max-h-[85vh] overflow-y-auto rounded-2xl bg-white dark:bg-[#0a0a0a] p-6 shadow-2xl custom-scrollbar"
          >
            {/* Icon */}
            <div className="mb-4 flex justify-center">
              <div className="rounded-full bg-[#0081FB]/20 p-4">
                <Icon icon="line-md:cog-filled" className="h-12 w-12 text-[#0081FB]" />
              </div>
            </div>
            ...
            <p className="mb-6 text-center text-sm text-gray-500 dark:text-white/60">
              {t('setup_desc')}
            </p>
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2">
                <div className="min-w-0 flex-1 overflow-hidden rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 px-3 py-2">
                  {extractPath ? (
                    <p
                      className="truncate text-xs text-gray-900 dark:text-white"
                      title={extractPath}
                    >
                      {extractPath}
                    </p>
            ...
            {extractPath && diskSpace && (
              <div className="mb-6 rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 p-4">
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  { value: 'light', icon: 'ph:sun-bold', label: t('settings_theme_light') },
                  { value: 'dark', icon: 'ph:moon-bold', label: t('settings_theme_dark') },
                  { value: 'system', icon: 'ph:monitor-bold', label: t('settings_theme_system') }
